...
Ts = 0.00084; # sampling interval
t = np.arange(0,0.10752,0.00084) # time vector; create Fs samples between 0 and 1.0 sec.
y = np.arange(0,0.10752,0.00084) # signal vector; create Fs samples
